    ...
    <div className="container-xxl">
      <div className="row justify-content-center justify-content-md-start">
        <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
          ...
          <div className='mb-3'><p><b>Address:</b> Sri Sai Homes, Chandanagar, Hyderabad</p> </div>
          <div className='mb-3'><p><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at (+91) 879041-8658</a></p> </div>
        ...
        <div className="col-md-4 col-lg-4">
          <h2 className='footer-title mb-3'><b>Install</b></h2>
      ...
      <div className="row">
        ...
        <p className="text-center text-md-start text-color-primary">&copy;Developed by Nirvana Enterprise 2023</p>
        </div>
        <div className="col-12 col-md-6">

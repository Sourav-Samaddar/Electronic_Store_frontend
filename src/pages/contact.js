...
import contactHeroImage from "../assets/images/banner/b1.jpg"
                    ...
                    <div className="row text-center align-items-center">
                        <div className="col-lg-6 col-md-12 p-3">
                            <div className="map card m-auto embed-responsive embed-responsive-16by9">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.0371720898324!2d78.33481547354529!3d17.50573889938814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb92873f96fa4d%3A0x69a7835cf9fb52e3!2sSri%20Sai%20Homes!5e0!3m2!1sen!2sin!4v1690974012200!5m2!1sen!2sin"
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="card p-5">
                                ...
                                <p className='mb-2'><b>Address:</b>  Sri Sai Homes, Chandanagar, Hyderabad</p>
                                <p className='mb-2'><b>Phone:</b>  <a className='footer-tel' href="tel:+1234567890">Call us at (+91) 879041-8658</a></p>
...
function Contact () {
    return (
        <Base title="Reach Out to Us" 
        HeroImage={contactHeroImage} description="We are only a step away from you">
            {contactView()}
        </Base>
    )
}
